...
export default async function InstructorDashboard() {
  ...
  return (
    <div className="space-y-8">
      <section>
        <p className="section-title mb-3">Mes prochains cours</p>
        {upcoming.length === 0 ? (
          <p className="text-sm text-stone2-500 italic">Aucun cours à venir.</p>
        ) : (
              ...
              return (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-stone2-500">inscrits</p>
                  </div>
                </Link>
              );
            })}
      ...
      <section>
        <p className="section-title mb-3">Historique récent</p>
        {past.length === 0 ? (
          <p className="text-sm text-stone2-500 italic">Aucun historique.</p>
        ) : (
            ...
            <table className="w-full text-sm">
              ...
              <tbody className="divide-y divide-stone2-100">
                {past.map((s) => {
                  ...
                  return (
                    <tr key={s.id}>
                      <td className="py-2 text-stone2-600">{formatDateTime(s.startTime)}</td>
