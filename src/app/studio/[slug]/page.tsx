    ...
    <div className="-mx-4 md:-mx-8 -my-10">
      ...
      <section className="relative bg-brand-600 text-cream-50 overflow-hidden min-h-[92vh] flex flex-col justify-center">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse 60% 75% at 5% 10%, rgba(242,72,31,0.20) 0%, transparent 55%), radial-gradient(ellipse 45% 55% at 95% 90%, rgba(255,106,67,0.12) 0%, transparent 50%)",
          }}
        />
          ...
          <div className="flex flex-col lg:flex-row lg:items-end gap-16 lg:gap-28">
            <div className="flex-1">
              ...
              <h1
                ...
                style={{ fontSize: "clamp(3.8rem, 12vw, 8rem)", letterSpacing: "-0.025em" }}
              >
                {settings.studioName}
              </h1>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="min-w-0">
                          ...
                          <p className="text-stone2-400 text-xs mt-0.5">
                            {DAYS_FR[s.startTime.getDay()]}{" "}
                            {s.startTime.toLocaleDateString("fr-FR", { day: "numeric", month: "short" })}
                            {" · "}
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div className="space-y-5">
              <p className="text-stone2-600 leading-relaxed">
                {settings.studioName} est né d&apos;une conviction simple : les meilleurs cours se donnent en petits
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-0 md:gap-px bg-transparent md:bg-stone2-200 md:border md:border-stone2-200">
            {[
              ...
              <div key={item.title} className="py-14 px-8 bg-white">
                <p className="font-mono text-xs text-accent-500 font-medium mb-6 tabular">0{i + 1}</p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-6">
            ...
            <div>
              <div className="flex items-center gap-3 mb-5">
                ...
                <span className="text-[9px] uppercase tracking-widest px-2 py-0.5 bg-accent-500 text-white font-semibold">Populaire</span>
              </div>
              {subs.length > 0 ? (
                <div className="space-y-3">
                  {subs.map((s) => (
